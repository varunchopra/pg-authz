...
```
000_config.sql           constants (max_group_depth, default_membership_relation)
001_validation.sql       input validation

010_helpers.sql          _expand_user_memberships, min_expiration
011_cycle_detection.sql  would_create_cycle, detect_cycles
...
032_maintenance.sql      get_stats, verify_computed, grant_to_resources_bulk
